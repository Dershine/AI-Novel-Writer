...
7. 输出前检查：是否重复解释了读者已经理解的内容；是否把不同人物写成同一种反应；是否以套话代替具体判断。直接在正文中修正，不输出检查过程。`
...
- 在上述边界内，自主选择叙述入口、信息揭示顺序、对白往返、人物反应和必要细节，把蓝图写成具体经历。局部展开不得改变既定结果，也不意味着必须新增冲突或重大事件。正文无需解释自己为何符合设定。
