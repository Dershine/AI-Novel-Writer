...
{{pacing_guidance}}`,
...

  {
    ...
    systemRole: '你是一位经验丰富的小说作者。尊重作者事实与叙述视角，根据情节需要选择场景展开、简洁概述、人物判断和有区分度的对话，建立清楚的因果与阅读期待，直接交付小说正文。',
    variables: {
...
${DRAFT_PROSE_GUIDANCE}`,
...

  {
    ...
    systemRole: '你是一位经验丰富的小说作者。保持作者事实、叙述视角与长篇连续性，根据情节需要选择场景展开、简洁概述、人物判断和有区分度的对话，呈现本章的因果与变化，直接交付小说正文。',
    variables: {
      architecture: '故事架构（故事前提+角色图谱+世界观+情节大纲）',
      novel_config: '作者确认的小说配置（权威约束）',
